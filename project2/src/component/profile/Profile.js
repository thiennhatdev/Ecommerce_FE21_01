...
class Profile extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            gender : JSON.parse(localStorage.getItem('profileUser')).gender,
            day : JSON.parse(localStorage.getItem('profileUser')).day,
            month : JSON.parse(localStorage.getItem('profileUser')).month,
            year : JSON.parse(localStorage.getItem('profileUser')).year,
            old_password : '',
            password : '',
            re_new_password : '',
            statusAccount : true
    ...
    logout = () => {
        ...
        localStorage.removeItem('productOfUser');
    }
                        ...
                        <div className="menu-left col-4 px-5">
                            ...
                            <ul className="" role="menu" aria-labelledby="dropdownMenu1">
                                <Link activeClassName='active'>
                                    <li  className='py-3  border-top ' onClick={ () => this.statusAccount() } >
                                        Cập nhật tài khoản
                                    </li>
                                </Link> 
                                ...
                                <li className='py-3  border-top'>
                                <Link to='/cart' >
                                <i className="ico ico-ic-my-order" /> <span>Quản lý đơn hàng</span>
                                </Link>
